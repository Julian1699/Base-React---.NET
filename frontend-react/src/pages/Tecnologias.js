...
import mysqlLogo from '../assets/images/postgres-logo.png';
import dotnetLogo from '../assets/images/dotnet-logo.png'; // Asegúrate de tener esta imagen
          ...
          <div className="text-center">
            ...
            <table className="table">
              <tbody>
                <tr>
                  <td>
                    <img src={dotnetLogo} alt="DotNet Logo" style={{ height: '30px', marginRight: '10px' }} />
