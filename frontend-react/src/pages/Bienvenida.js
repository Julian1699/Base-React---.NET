      ...
      <div className="card">
        <div className="card-body text-center">
          ...
          <ul className="list-unstyled">
            ...
            <li className="mb-2">
              <p>• El propósito de este proyecto es demostrar cómo se puede construir una aplicación web completa utilizando React para el frontend y .NET para el backend.</p>
            </li>
            <li className="mb-2">
